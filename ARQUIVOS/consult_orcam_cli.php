                ...
                <div class="content law">
                    ...
                    <form method="POST" action="">
                        <div class="user-details">
                            <div class="input-box">
                                <h1 class='service'>Nome do cliente</h1>
                                <span class="details"></span>
                                <input type="text" name="cliente" placeholder="Nome do Cliente" size="60">
                            </div>

                            <div class="button">
                                <a><input name="sendPesqCli" type="submit" value="Buscar"></a>
                            </div>
                            <br>
                    ...
                    if ($sendPesqCli) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<div class='server'>"."Cliente: " . $row['nome'] . "<br>";
