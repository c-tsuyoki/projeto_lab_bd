	...
	<section class="sec">
		...
		<div class="login-boxer">
			...
			<ul class="ok_on2">
				...
				<li><a href="lista_prestadores.php"><button class="btn_ btn_1">Prestadores</button></a></li>
			...
			<div class="tab">
				<table class="craft-table" >
					...
					while ($row = mysqli_fetch_assoc($resultado_usuarios)) {
						...
						echo $row['nome'] . "</td><td>" . $row['endereco'] . "</td><td>" . $row['complemento'] . "</td><td>" . $row['bairro'] . "</td><td>" . $row['cidade'] . "</td><td>" . $row['estado'] . "</td><td>" . $row['email'] . "</td><td>" . $row['telefone'] . "</td><td>" . $row['celular'] . "</td><td>" . $row['cep'] . "</td><td> <a class='ed' href='tela_edit_prestadores.php?id=" . $row['id'] . "'>Editar</a>";
						echo "</td><td> <a class='ed' href='del_prestadores.php?id=" . $row['id'] . "'>Excluir </a></td></tr>";
					}
					echo "</table>";
