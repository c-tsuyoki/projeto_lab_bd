...
<body>
  ...
  <section class="sec">
    ...
    <div class="container">
      ...
      <div class="title">
        <a href="cadastro_cliente.php"><button class="btn_click btn_ex">Cliente</button></a>
        <a href="#"><button class="btn_press btn_ex">Prestador</button></a>
      </div>
      <div class="content">
        <form method="post" action="inclusao_prestadores.php">
          ...
          <div class="button">
            <a href="tela_prestador_login.php"><input type="submit" value="Registrar"></a>
          </div>
        </form>
      </div>
    </div>
