	...
	<section class="sec">
		...
		<div class="login-boxer">
			...
			<ul class="ok_on2">
				...
				<li><a href="lista_categoria.php"><button class="btn_ btn_1">Categorias</button></a></li>
			...
			<div class="tab">
				<table class="craft-table">
					...
					while ($row = mysqli_fetch_assoc($resultado_usuarios)) {
						...
						echo $row['categoria'] . "</td><td> <a class='ed' href='tela_edit_categoria.php?id=" . $row['id'] . "'>Editar</a>";
						echo "</td><td> <a class='ed' href='del_categoria.php?id=" . $row['id'] . "'>Excluir </a></td></tr>";
					}
					echo "</table>";
