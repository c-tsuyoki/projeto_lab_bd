	...
	<section class="sec">
		...
		<div class="login-boxer">
			...
			<ul class="ok_on2">
				...
				<li><a href="lista_servicos.php"><button class="btn_ btn_1">Serviços</button></a></li>
			...
			<div class="tab">
				<table class="craft-table">
					...
					while ($row = mysqli_fetch_assoc($resultado_usuarios)) {
						...
						echo $row['servico'] . "</td><td>" . $row['id_categoria'] . "</td><td> <a class='ed' href='tela_edit_servicos.php?id=" . $row['id'] . "'>Editar</a>";
						echo "</td><td> <a class='ed' href='del_servicos.php?id=" . $row['id'] . "'>Excluir </a></td></tr>";
					}
					echo "</table>";
